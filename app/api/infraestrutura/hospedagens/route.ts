...
import { listarHospedagens, criarHospedagem, atualizarHospedagem, apagarHospedagem } from "@/lib/infraestrutura";
import { TabelaAusenteError } from "@/lib/acessos-cofre";

export const dynamic = "force-dynamic";

// ── Acessos & Infra › Hospedagens ────────────────────────────────────────────
...
export async function GET() {
  ...
  try { return NextResponse.json({ hospedagens: await listarHospedagens() }); }
...
export async function POST(req: NextRequest) {
  ...
  try { return NextResponse.json({ hospedagem: await criarHospedagem(b, me.id) }); }
  catch (e) { return erro(e); }
}
...
export async function PATCH(req: NextRequest) {
  ...
  try { return NextResponse.json({ hospedagem: await atualizarHospedagem(b.id, b) }); }
  catch (e) { return erro(e); }
}
...
export async function DELETE(req: NextRequest) {
  ...
  try { await apagarHospedagem(id); return NextResponse.json({ ok: true }); }
  catch (e) { return erro(e); }
}
