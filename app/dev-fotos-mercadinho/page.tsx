// TEMPORÁRIO — banco de provas da tela /fotos-mercadinho, pra medir o
...
export default function DevFotosMercadinho() {
  ...
  return <FaxinaDeFotos catalogo="mercadinho" demo />;
}
