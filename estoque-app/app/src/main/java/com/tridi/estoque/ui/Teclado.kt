...
private fun RowScope.Tecla(
    ...
    val fundo = when {
        primaria && !desabilitada -> GalpaoAcento
        primaria -> GalpaoSuperficieAlta
        destaque -> GalpaoSuperficieAlta
        else -> GalpaoSuperficieAlta
    }
    val cor = if (primaria && !desabilitada) GalpaoSobreAcento else GalpaoTexto
    ...
    Surface(
        ...
        Box(contentAlignment = Alignment.Center) {
            Text(
                text = rotulo,
                color = cor,
                fontFamily = if (umCaractere) FonteTitulo else FonteTexto,
