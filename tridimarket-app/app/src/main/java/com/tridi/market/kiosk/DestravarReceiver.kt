...
//
//   adb shell am broadcast -a com.tridi.market.DESTRAVAR --es token <TOKEN>
...
//
//   adb shell am broadcast -a com.tridi.market.DESTRAVAR --es token <TOKEN> --ez remover_owner true
...
class DestravarReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        runCatching {
            context.startActivity(
                Intent(context, com.tridi.market.MainActivity::class.java)
    ...
    companion object {
        private const val TAG = "TridiMarketKiosk"
        ...
        // totem por acidente.
        const val TOKEN = "tridi-market-destravar"
